...
@section('pageTitle', 'Rekap Pangkal')
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Rekap Pangkal']])
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="card-title inline-block">Data rekappangkal</h5>
                            </div>
                            <div>
                                <a href="{{ route('pangkalexport') }}" class="btn btn-danger rounded-pill px-4" style="font-size: 0.75rem" >Export Excel</a>
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/hapusrekapPangkal/{{ $value->id }}" button type="button"
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalrekappangkal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Input rekappangkal </h1>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/prosesrekapPangkal" class="row g-3">
                                    @csrf
  ...
  ?>
    <div class="modal fade" id="editModal{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit rekappangkal Sekolah</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/updaterekapPangkal" class="row g-3">
                                    @csrf
