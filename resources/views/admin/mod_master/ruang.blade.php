...
@section('pageTitle', 'Ruangan')
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Ruangan']])
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="card-title inline-block">Data Ruangan</h5>
                            </div>
                            <div>
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/hapusRuang/{{ $value->id }}" button type="button"
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalruang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/updateRuang" class="row g-3">
                                    @csrf
