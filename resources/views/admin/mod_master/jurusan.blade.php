...
@section('pageTitle', 'Jurusan')
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Jurusan']])
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="card-title inline-block">Data Jurusan</h5>
                            </div>
                            <div>
                                <button class="btn btn-primary rounded-pill px-4" style="font-size: 0.9rem"
                                    data-bs-toggle="modal" data-bs-target="#modalJurusan"><i class="bi bi-plus"></i>
                                    Jurusan</button>
                            </div>
                        </div>
                        <hr>
                        {{-- <form action="/search" class="search-form d-flex justify-content-end position-relative"
                            method="GET">
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/hapusJurusan/{{ $value->id }}" button type="button"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Input Jurusan </h1>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/prosesJurusan" class="row g-3">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">Nama Jurusan</label>
                                        <input type="text" name="nama_jurusan" class="form-control"
                                            id="validationDefault01" hint="Nama Jurusan" placeholder="Masukkan Nama Jurusan" required>
                                    </div>
  ...
  ?>
    <div class="modal fade" id="editModal{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Jurusan Sekolah</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/updateJurusan" class="row g-3">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $value->id }}">
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">Nama Jurusan</label>
                                        <input type="text" name="nama_jurusan" value="{{ $value->nama_jurusan }}"
