...
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Notifikasi']])
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="card-title inline-block">Data Notifikasi</h5>
                            </div>
                            <div>
                                <button class="btn btn-primary rounded-pill px-4" style="font-size: 0.9rem"
                                    data-bs-toggle="modal" data-bs-target="#modalnotif"> + Notifikasi</button>
                            </div>
                        </div>
                        <hr>
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>{{ $value->kode_notif }} </td>

                                    <td>
                                        <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                            data-bs-target="#editModal{{ $value->id }}"><i
                                                class="bi bi-pencil"></i></button>
                                        <a href="/hapusnotifikasi/{{ $value->id }}" button type="button"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Input Notifikasi </h1>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/prosesnotifikasi" class="row g-3">
                                    @csrf
  ...
  ?>
    <div class="modal fade" id="editModal{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Notifikasi</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/updatenotifikasi" class="row g-3">
                                    @csrf
                                    ...
                                    <div class="col-md-12">
                                        <label for="kode_notif" class="form-label">Kode Notif</label>
                                        <input type="text" value="{{ $value->kode_notif }}" name="kode_notif"
                                            class="form-control" id="kode_notif" hint="kode notif" required>
                                    </div>
