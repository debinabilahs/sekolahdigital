...
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Level']])
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="card-title inline-block">Data Level</h5>
                            </div>
                            <div>
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/hapusLevel/{{ $value->id }}" button type="button"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/updatelevel" class="row g-3">
                                    @csrf
