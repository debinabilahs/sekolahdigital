...
@section('pageTitle', 'Materi')
@section('breadcrumb')
    @include('partials.breadcrumbs', ['breadcrumbs' => ['Materi']])
@endsection
@section('content')
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/hapusmateri/{{ $value->id }}" button type="button"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/prosesmateri" class="row g-3" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/lihatmateri" class="row g-3">
                                    @csrf
